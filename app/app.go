...
type App struct {
	*baseapp.BaseApp
	...
	NucleusKeeper nucleusmodulekeeper.Keeper
...
func New(
	...
	*/
	...
	app.NucleusKeeper = *nucleusmodulekeeper.NewKeeper(
		appCodec,
		keys[nucleusmoduletypes.StoreKey],
		keys[nucleusmoduletypes.MemStoreKey],
		app.GetSubspace(nucleusmoduletypes.ModuleName),
	)
	nucleusModule := nucleusmodule.NewAppModule(appCodec, app.NucleusKeeper, app.AccountKeeper, app.BankKeeper)
