...
type HTLC struct {
	...
	ExpirationHeight uint64                                   `protobuf:"varint,8,opt,name=expiration_height,json=expirationHeight,proto3" json:"expiration_height,omitempty" yaml:"expiration_height"`
	State            HTLCState                                `protobuf:"varint,9,opt,name=state,proto3,enum=nucleus.htlc.HTLCState" json:"state,omitempty"`
	ClosedBlock      uint64                                   `protobuf:"varint,10,opt,name=closed_block,json=closedBlock,proto3" json:"closed_block,omitempty" yaml:"closed_block"`
}
...
var fileDescriptor_c03699801a204f8b = []byte{
	...
	,
}
