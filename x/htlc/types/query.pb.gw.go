...
var (
	pattern_Query_HTLC_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"nucleus", "htlc", "htlcs", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_AssetSupply_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"nucleus", "htlc", "supplies", "denom"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_AssetSupplies_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"nucleus", "htlc", "supplies"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"nucleus", "htlc", "params"}, "", runtime.AssumeColonVerbOpt(true)))
)
